...
- Dokumentaatio 13p
  ...
  - Selvitys ChatGPT:n ja muiden kielimalleihin perustuvien välineiden käytöstä. **Huom:** tämä annetaan muusta dokumentaatiosta erillään [Moodlesta]({{site.moodle_link}}) löytyvän lomakkeen avulla.
- Testaus 5p
  - Testit
