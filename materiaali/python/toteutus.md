...
Käynnistä asennuksen jälkeen terminaali uudestaan. Halutun Python-version, kuten version 3.12.2, asennus ja käyttöönotto onnistuu seuraavasti:

1. Asenna Python-versio 3.12.2 komennolla:
...
3. Varmista, että Python-versio on 3.12.2 komennolla `python3 --version`
