---
layout: page
permalink: /java/arvosteluperusteet
...
- Eräs tapa laajentaa sovellusta ja lisätä sen kompleksisuutta on tehdä siitä _parametrein konfiguroitava ja laajennettava_, esim:
  ...
  - Konfiguroitavuus voidaan toteuttaa joko käyttöliittymän tai [konfiguraatiotiedostojen](/java/toteutus#sovelluksen-konfiguraatiot) avulla
...
- Pääset testaamaan ohjelmaasi laitoksen koneella (valitse Cubbli Linux) myös kotoa käsin käyttämällä etätyöpöytää https://helpdesk.it.helsinki.fi/ohjeet/tietokone-ja-tulostaminen/tyoasemapalvelu/etakaytettavat-tyopoydat-vdi-ja-vmware
