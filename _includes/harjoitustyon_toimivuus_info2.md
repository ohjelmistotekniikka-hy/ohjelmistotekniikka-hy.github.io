...
3. Varmista, että PDM on asennettu suorittamalla komento `pdm --version`. Jos asennus puuttuu, seuraa [näitä]() Linux-asennuksen ohjeita
4. Kloonaa repositoriosi haluamaasi hakemistoon `git clone`-komennolla
5. Siirry repositoriosi hakemistoon ja asenna riippuvuudet komennolla `pdm install`. Huomaa, että komento tulee suorittaa hakemistossa, jossa _pyproject.toml_-tiedosto sijaitsee
